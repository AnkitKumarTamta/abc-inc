...
const RegisterForm = () => {
  ...
  <div className="container py-5 h-100 shadow-sm p-3 mb-5 bg-white rounded">
          ...
          <div className="row g-0">
            ...
            <div className="col-xl-6">
              <div className="card-body p-md-5 text-black">
                <h3 className="mb-5 text-uppercase text-center">Registration</h3>
                ...
                <div className="d-flex justify-content-end pt-3">
                  ...
                  <button type="button" className="btn btn-primary btn-lg ms-2">Submit form</button>
                </div>
